...
module ProjectFile_mm_interconnect_0 (
	...
	wire   [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> REG_s1_agent:cp_channel
	...
	wire  [91:0] piobuttom_s1_agent_rf_source_data;                                         // PioButtom_s1_agent:rf_source_data -> PioButtom_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] piobuttom_s1_agent_rsp_fifo_out_data;                                      // PioButtom_s1_agent_rsp_fifo:out_data -> PioButtom_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> PioButtom_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // PioButtom_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> PioButtom_s1_agent:cp_channel
	...
	wire  [90:0] piobuttom_s1_agent_rp_data;                                                // PioButtom_s1_agent:rp_data -> router_007:sink_data
