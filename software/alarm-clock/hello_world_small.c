...
volatile int edge_capture_up, edge_capture_down, edge_capture_left, edge_capture_right;
volatile int edge_capture_alarm_active, edge_capture_timer_active, edge_capture_save;
volatile int edge_capture_alarm_editing, edge_capture_timer_editing, edge_capture_time_editing;
...
int main()
{
 ...
 void init_interrupts(){
	  ...
	  //Enables the timer interrupts
	    ...
	    add_pio_interrupt(PIODOWNBUTTON_BASE,PIODOWNBUTTON_IRQ_INTERRUPT_CONTROLLER_ID,
	    		PIODOWNBUTTON_IRQ,handle_down_button_interrupt,edge_capture_ptr_down);

	    void* edge_capture_ptr_left = (void*) &edge_capture_left;
	    add_pio_interrupt(PIOLEFTBUTTON_BASE,PIOLEFTBUTTON_IRQ_INTERRUPT_CONTROLLER_ID,
	    		PIOLEFTBUTTON_IRQ,handle_left_button_interrupt,edge_capture_ptr_left);

	    void* edge_capture_ptr_right = (void*) &edge_capture_right;
	    add_pio_interrupt(PIORIGHTBUTTON_BASE,PIORIGHTBUTTON_IRQ_INTERRUPT_CONTROLLER_ID,
	    		PIORIGHTBUTTON_IRQ,handle_right_button_interrupt,edge_capture_ptr_right);


	    void * edge_capture_ptr_alarm_active = (void *) &edge_capture_alarm_active;
	    add_pio_interrupt(ALARMACTIVESWITCH_BASE,ALARMACTIVESWITCH_IRQ_INTERRUPT_CONTROLLER_ID,
	    		ALARMACTIVESWITCH_IRQ,handle_alarm_active_switch_interrupt,edge_capture_ptr_alarm_active);

	    void * edge_capture_ptr_timer_active = (void *) &edge_capture_timer_active;
	    add_pio_interrupt(TIMERACTIVESWITCH_BASE,TIMERACTIVESWITCH_IRQ_INTERRUPT_CONTROLLER_ID,
	    		TIMERACTIVESWITCH_IRQ,handle_timer_active_switch_interrupt,edge_capture_ptr_timer_active);

	    void * edge_capture_ptr_alarm_editing = (void *) &edge_capture_alarm_editing;
	    add_pio_interrupt(EDITALARMSWITCH_BASE,EDITALARMSWITCH_IRQ_INTERRUPT_CONTROLLER_ID,
	    		EDITALARMSWITCH_IRQ,handle_alarm_editing_switch_interrupt,edge_capture_ptr_alarm_editing);

	    void * edge_capture_ptr_timer_editing = (void *) &edge_capture_timer_editing;
	    add_pio_interrupt(EDITTIMERSWITCH_BASE,EDITTIMERSWITCH_IRQ_INTERRUPT_CONTROLLER_ID,
	    		EDITTIMERSWITCH_IRQ,handle_timer_editing_switch_interrupt,edge_capture_ptr_timer_editing);

	    void * edge_capture_ptr_time_editing = (void *) &edge_capture_time_editing;
	    add_pio_interrupt(EDITTIMESWITCH_BASE,EDITTIMESWITCH_IRQ_INTERRUPT_CONTROLLER_ID,
	    		EDITTIMESWITCH_IRQ,handle_time_editing_switch_interrupt,edge_capture_ptr_time_editing);
	    ...
	    add_pio_interrupt(SAVESWITCH_BASE,SAVESWITCH_IRQ_INTERRUPT_CONTROLLER_ID,
	    		SAVESWITCH_IRQ,handle_save_switch_interrupt,edge_capture_ptr_save);
}
